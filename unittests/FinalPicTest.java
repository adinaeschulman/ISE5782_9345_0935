...
class FinalPicTest {
    ...
    public void Mine() {
        ...
        Helicopter choper = new Helicopter(new Point(0, 0, 0), 8);
//add a plane to geometries as a background

        constGeometries.add( new Plane(new Point(0, -100, -200), axisY).setEmission(new Color(155, 118, 83))
...
//draw an circel around the H at the floor background
        ...
        constGeometries.add(new
                ...
                Circle(new Point(0, -100 + 0.07, 0), axisY, 68)
                .
        ...
        constGeometries.add(new
                ...
                Circle(new Point(0, -100 + 0.08, 0), axisY, 65)
                .
        ...
        scene.getGeometries().add(choper);
