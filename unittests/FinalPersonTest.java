...
//        scene.getGeometries().add(sphere3);
        ...
        //arms
        //left arm
        Geometry sphere6 = new Sphere(new Point(290, -480, -1000), 90).setEmission(new Color(0, 0, 255)).setMaterial(new Material().setKT(1).setShininess(20));
        scene.getGeometries().add(sphere6);
        Geometry sphere7 = new Sphere(new Point(310, -510, -1000), 90).setEmission(new Color(0, 0, 255)).setMaterial(new Material().setKT(1).setShininess(20));
        scene.getGeometries().add(sphere7);
        Geometry sphere8 = new Sphere(new Point(330, -540, -1000), 90).setEmission(new Color(0, 0, 255)).setMaterial(new Material().setKT(1).setShininess(20));
        scene.getGeometries().add(sphere8);
        Geometry sphere9 = new Sphere(new Point(40, -570, -1000), 90).setEmission(new Color(0, 0, 255)).setMaterial(new Material().setKT(1).setShininess(20));
        scene.getGeometries().add(sphere9);
        Geometry sphere10 = new Sphere(new Point(350, -600, -1000), 90).setEmission(new Color(0, 0, 255)).setMaterial(new Material().setKT(1).setShininess(20));
